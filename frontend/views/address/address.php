...
<div class="main w1210 bc mt10">
	...
	<div class="content fl ml10">
		<div class="address_hd">
			...
			<dl>
				<dt><?=$row->user_name.'&nbsp;&nbsp;'.$row->sheng.'省->'.$row->shi.'市->'.$row->xian?></dt>
				<dd>
					<?=\yii\bootstrap\Html::a('修改',['address/edit','id'=>$row->id])?>
					<?=\yii\bootstrap\Html::a('删除',['address/del','id'=>$row->id])?>
				</dd>
			</dl>
			<?php }?>
		</div>
			...
			<?php $form = \yii\widgets\ActiveForm::begin()?>
				<ul>
					<li>
						...
						<input type="text" name="Address[consignee]" class="txt" value="<?=$model->consignee?>" />
					</li>

					<li>
						<label for=""><span>*</span>所在地区：</label>
						<select name="Address[sheng]" id="province">
							<option value="<?=$model->sheng?$model->sheng:' '?>"> <?=$model->sheng?$model->sheng:'=请选择='?></option>
						</select>

						<select name="Address[shi]" id="city">
							<option value="<?=$model->sheng?$model->shi:' '?>"><?=$model->sheng?$model->shi:'=请选择='?></option>
						</select>

						<select name="Address[xian]" id="area">
							<option value="<?=$model->sheng?$model->xian:' '?>"><?=$model->sheng?$model->xian:'=请选择='?></option>
						</select>
					</li>
					<li>
						<label for=""><span>*</span>详细地址：</label>
						<input type="text" name="Address[detailed]" class="txt address" value="<?=$model->detailed?>" />
					</li>
					<li>
