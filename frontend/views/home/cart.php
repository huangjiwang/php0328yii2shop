...
<div class="mycart w990 mt10 bc">
	...
	<table>
		...
		<tr data-id="<?=$model['id']?>">
			<td class="col1"><a href=""><?=\yii\helpers\Html::img('http://img.yiishop.com:8080'.$model['logo'],['style'=>'width:50px'])?></a>
			...
			<td class="col6"><?=\yii\bootstrap\Html::a('删除',['home/del-cart','goods_id'=>$model['id']])?></td>
		</tr>
		<?php endforeach;?>
		</tbody>
		<tfoot>
