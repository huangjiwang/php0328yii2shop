...
<body>
	...
	<div class="main w1210 mt10 bc">
		...
		<div class="goods_content fl mt10 ml10">
			<!-- 商品概要信息 start -->
			<div class="summary">
				<h3><strong><?=$model2->name?></strong></h3>
				
				<!-- 图片预览区域 start -->
				<div class="preview fl">
					<div class="midpic">
						<a href="images/preview_l1.jpg" class="jqzoom" rel="gal1">   <!-- 第一幅图片的大图 class 和 rel属性不能更改 -->
							<?=\yii\helpers\Html::img('http://img.yiishop.com:8080'.$model2->logo,['style'=>'width:350px'])?>               <!-- 第一幅图片的中图 -->
						</a>
					</div>
					...
					<div class="smallpic">
						...
						<div class="smallpic_wrap">
							<ul>
								...
								<li class="cur">
									<a class="zoomThumbActive" href="javascript:void(0);" rel="{gallery: 'gal1', smallimage: 'images/preview_m1.jpg',largeimage: 'images/preview_l1.jpg'}"><?=\yii\helpers\Html::img('http://img.yiishop.com:8080'.$row->path,['style'=>'width:80px'])?></a>
								</li>
								<?php }?>
							</ul>
						</div>
				...
				<div class="goodsinfo fl ml10">
					<ul>
						<li><span>商品编号： </span><?=$model2->sn?></li>
						<li class="market_price"><span>定价：</span><em>￥<?=$model2->market_price?></em></li>
						<li class="shop_price"><span>本店价：</span> <strong>￥<?=$model2->shop_price?></strong> <a href="">(降价通知)</a></li>
						<li><span>上架时间：</span><?=$model2->create_time?></li>
						<li class="star"><span>商品评分：</span> <strong></strong><a href="">(已有21人评价)</a></li> <!-- 此处的星级切换css即可 默认为5星 star4 表示4星 star3 表示3星 star2表示2星 star1表示1星 -->
					</ul>
					<form action="/index.php" method="get" class="choose">
						<input type="hidden" name="r" value="home/add-to-cart" />
						<ul>
							<li>
								<dl>
									<dt>购买数量：</dt>
			...
			<div class="detail">
				...
				<div class="detail_bd">
					...
					<div class="introduce detail_div none">
						<div class="attr mt15">
							<ul>
								<li><span>商品名称：</span><?=$model2->name?></li>
								<li><span>商品编号：</span><?=$model2->sn?></li>
								<li><span>品牌：</span><?=$model2->name?></li>
								<li><span>上架时间：</span><?=$model2->create_time?></li>
