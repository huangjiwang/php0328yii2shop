		...
		<div class="logo w1210">
			...
			<div class="search fl">
				<div class="search_form">
					...
					<form action="index.php" name="serarch" method="get" class="fl">
						<input type="hidden" name="r" value="home/test" />
						<input type="text" class="txt" value="请输入商品关键字" name="matches"/><input type="submit" class="btn" value="搜索" />
					</form>
				...
				<div class="cat_bd">
					...
					<div class="cat item1">
						...
						<div class="cat_detail">
							...
							<dl class="dl_1st">
								<dt><a href=""><?=$row2->name?></a></dt>
								<?php foreach($row2->children as $row3){?>
								<dd>
									<?=\yii\bootstrap\Html::a("$row3->name",['home/goods','id'=>$row3->id])?>
								</dd>
								<?php }?>
							</dl>
							<?php }?>
